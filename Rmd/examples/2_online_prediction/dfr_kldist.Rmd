...
devtools::load_all('/home/lucas/heimdall/')
# library(heimdall)
```
...
model <- stealthy(
  ...
  drift_method=dfr_kldist(window_size=batch_size*2, breaks=20, p_th=0.35), # Using KLDIST
  norm_class=nrm_memory(norm_class = daltoolbox::zscore()), # Normalization with MinMax
