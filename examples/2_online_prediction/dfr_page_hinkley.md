---
title: "dfr_page_hinkley Online Prediction Example"
output:
  html_document: 
    self_contained: true
---
...
model <- stealthy(
  ...
  drift_method=dfr_page_hinkley(target_feat='serie'), # Using Page_Hinkley
...
## 1           2  0  0  0  0       0 0.0006551743
## 2           3 33  0 17  0       0 0.0064527988
## 3           4 27  0 23  0       0 0.0026748180
## 4           5 26  0 23  1       0 0.0026154518
## 5           6  0  0 23 27       0 0.0026538372
## 6           7  0  0  0  0       1 0.0025091171
## 7           8 24  1 25  0       0 0.0068047047
## 8           9 19  0 31  0       0 0.0025925636
## 9          10 25  0 25  0       0 0.0025730133
```
...
```
## [1] "Precision 0.993548387096774 Recall 0.846153846153846 F1 0.913946587537092 Accuracy 0.917142857142857"
```
